# existing-mono-inrepo-noport-noingress-autodeploy-20250820102629
...
```
docker build -t existing-mono-inrepo-noport-noingress-autodeploy-20250820102629:latest .
docker run -p:5030:8080 existing-mono-inrepo-noport-noingress-autodeploy-20250820102629:latest
```
